...
$router->get('/asistencia/marcaciones/exportar', [AttendanceController::class, 'exportPunches']);
$router->get('/asistencia/manual', [AttendanceController::class, 'manualRecords']);
$router->post('/asistencia/manual', [AttendanceController::class, 'updateManualRecord']);
